...
if (isset($_GET['type']) && $_GET['type'] != '') {
    ...
    if ($type == 'status') {
        ...
        $status_update = "update category set status = '$status' where id = '$id'";
        mysqli_query($con, $status_update);
    }
}
$sql = "select * from category order by status desc";
    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-secondary rounded h-100 p-4">
                <h3 class="text-center text-white">Category Management</h3><br><br>
                <div class="table-responsive">
                    <table class="table table-bordered border-light">
                        <thead>
                            <tr>
                                <th style="color:white;" scope="col">ID</th>
                                <th style="color:white;" scope="col">Category Name</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                ?>
                                    ...
                                    <td style="color:white;"><a href="category_delete.php?id=<?php echo $rows['id'] ?>">
                                            ...
                                            <a href="category_update.php?id=<?php echo $rows['id'] ?>">
                                                <script src="https://cdn.lordicon.com/lordicon.js"></script>
                                                <lord-icon
