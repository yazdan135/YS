...
<head>
    <meta charset="utf-8">
    <title>YS Traders | Admin Dashboard</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>YS | Traders</h3>
                </a>
                <div class="d-flex align-items-center ms-4 mb-4">
                    ...
                    <div class="ms-3">
                        <h6 class="mb-0">Muhammad Yazdan</h6>
                        <span>Admin</span>
                    </div>
                </div>
                <div class="navbar-nav w-100">
                    ...
                    <a href="./marqee_show.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Marqee text</a>
                    <a href="./contact_show.php" class="nav-item nav-link"><i class="fa fa-th me-2"></i>Contact Us</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            ...
                            <span class="d-none d-lg-inline-flex">Muhammad Yazdan</span>
                        </a>
